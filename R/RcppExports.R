...
WriteAttribute <- function(loc, attributename, mat, datatype, dimensions, size) {
    .Call('h5_WriteAttribute', PACKAGE = 'h5', loc, attributename, mat, datatype, dimensions, size)
}
