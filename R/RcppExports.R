...
CreateAttribute_CommonFG <- function(loc, attributename, datatype, dimensions, size) {
    .Call('h5_CreateAttribute_CommonFG', PACKAGE = 'h5', loc, attributename, datatype, dimensions, size)
}
...
OpenAttribute_CommonFG <- function(loc, attributename) {
    .Call('h5_OpenAttribute_CommonFG', PACKAGE = 'h5', loc, attributename)
}
